...
export interface IPolicy extends IAddRuleBool, IRemoveRuleBool, IClear, Iterable<string[]> {
    on<E extends keyof IPolicyEvents>(
        event: E, listener: IPolicyEvents[E]
    ): this;
    ...
    emit<E extends keyof IPolicyEvents>(
        event: E, ...args: Parameters<IPolicyEvents[E]>
    ): boolean;
}
