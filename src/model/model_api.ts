...
export interface IModel extends IAddRuleBool, IRemoveRuleBool {
	on<E extends keyof IModelEvents>(
        event: E, listener: IModelEvents[E]
    ): this;

	once<E extends keyof IModelEvents>(
        event: E, listener: IModelEvents[E]
    ): this;
    
	off<E extends keyof IModelEvents>(
        event: E, listener: IModelEvents[E]
    ): this;

    emit<E extends keyof IModelEvents>(
        event: E, ...args: Parameters<IModelEvents[E]>
    ): boolean;
